...
export function createEditorState() {
    ...
    return {
        ...
        /*Metodo que permite probar la entrada de la gramatica*/
        async probarGramatica() {
            ...
            try {
                ...
                if (this.errores.length > 0) {
                    ...
                    this.datosResultado = {
                        tipo: "error",
                        titulo: "Errores Sintacticos o Lexicos",
                        mensaje: "Se han detectado errores Lexicos o Sintacticos en tu gramatica"
                    };
                ...
                if (erroresSemanticos.length > 0) {
                    ...
                    this.datosResultado = {
                        ...
                        mensaje: "Se han detectado errores Semanticos en tu gramatica"
                    };
                ...
                if (erroresAmbiguos.length > 0) {
                    ...
                    this.datosResultado = {
                        tipo: "error",
                        titulo: "Errores de Ambiguedad",
                        mensaje: "Se han detectado errores de Ambiguedad en tu gramatica"
                    };
                ...
                this.datosResultado = {
                    tipo: "exito",
                    titulo: "Compilacion Exitosa",
                    mensaje: `El codigo de entrada esta bien estructurado.`
                };

                this.logConsola += `\n\n[EXITOSO] Gramatica compilada sin ningun error.`;
                ...
                this.datosResultado = {
                    tipo: "error",
                    titulo: "Se han detectado errores",
                    mensaje: e.message
                };
                this.logConsola += `\n\n[ERROR] Se han reportado errores: ${e.message}`;
